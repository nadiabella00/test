...
@section('content')
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <tr>
                <th>Rute</th>
                <td>{{ $booking->package->route }}</td>
            </tr>
            <tr>
                <th>Jam Keberangkatan</th>
                <td>{{ $booking->package->departure_time }}</td>
            </tr>
            <tr>
                <th>Jam Kedatangan</th>
                <td>{{ $booking->package->arrival_time }}</td>
            </tr>
            <tr>
                <th>Harga</th>
                <td>Rp. {{ $booking->package->price * $booking->number_of_passengers }}</td>
            </tr>
            <tr>
                <th>Tanggal</th>
                <td>{{ $booking->package->date }}</td>
            </tr>
            <tr>
                <th>Kelas</th>
                <td>{{ $booking->package->class }}</td>
            </tr>
            <tr>
                <th>Status</th>
                <td>{{ $booking->package->status }}</td>
            </tr>
        </table>
    </div>
